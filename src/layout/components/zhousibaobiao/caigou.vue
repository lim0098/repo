<template>
  ...
  <el-table :data="fetchData1" style="width: 100%" border>
    ...
    <el-table-column prop="title" label="采购项目" width="150">
...
// console.log(startDate.value,'110')
